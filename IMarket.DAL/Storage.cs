...
namespace IMarket.DAL
{
    public static class Storage
    {
        ...
        { 
            return Stock.GroupBy(x => x.Name, (a,b) => new ViewModelListItem {Name = a, Color = b.First().Color, DeliveryTime = b.First().DeliveryTime, Type = b.First().ConcreteType, Count = b.Count()});
        }
    }
}
